...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_produto_service_produto_service__ = __webpack_require__(138);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PedidoServiceProvider = (function () {
    function PedidoServiceProvider(http, afd, ProdutoServiceProvider) {
        this.http = http;
        this.afd = afd;
    ...
    PedidoServiceProvider.prototype.criarPedido = function (dadosPedido, dadosProdutos) {
        ...
        this.afd.list('/pedidos/').push(dadosPedido).then(function (pedido) {
            ...
            for (i = 0; i < dadosProdutos.length; i++) {
                //alert(i);
                _this.afd.list('/pedidos/' + pedido.key + '/itens/').push(dadosProdutos[i]).then(function (prodd) {
                    //          alert(prodd);
                    //          alert('aaa');
                    //          salvou = true;
                });
    ...
    PedidoServiceProvider.prototype.baixaEstoque = function (prod) {
        var qtdAtual, novaQtd = 0;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_status_bar__ = __webpack_require__(271);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_produto_service_produto_service__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_common_http__ = __webpack_require__(230);
